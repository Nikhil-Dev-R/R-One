...
import com.rudraksha.trackme.repo.CityRepository
import com.rudraksha.trackme.repo.WeatherRepository
...
// Helper to convert icon string to resource ID (customize this logic)
/*fun getIconResource(icon: String): Int {
    return when (icon) {
        "01d" -> R.drawable.sun // Replace with your drawable resources
        "02d" -> R.drawable.cloudy_sun
