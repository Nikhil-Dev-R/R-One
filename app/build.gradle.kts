...
dependencies {
    ...
    implementation("com.google.maps.android:maps-compose:2.11.1") // Maps Compose support
    implementation("com.google.android.gms:play-services-location:21.0.1") // Location services

    implementation(libs.androidx.lifecycle.viewmodel.compose)
    implementation("com.google.accompanist:accompanist-permissions:0.31.1-alpha") // For permissions
